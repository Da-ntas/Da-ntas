...
<p align="left" style="display: flex; flex-direction: column; align-items: center; gap: 15px; width: 100%"> 
        ...
        <span style="display: flex; gap: 10px"> <a
        ...
        <span  style="display: flex; gap: 10px"> <a href="https://www.php.net" target="_blank" rel="noreferrer">
